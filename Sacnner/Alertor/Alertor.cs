       ...
       // private byte current_state = 0x00;
        ...
        public void GreenLightOn()
        {
            lock(lock_object)
            {
                ...
                List<Byte> data = new List<byte> { 0x01, 0x0F, 0x00, 0x00, 0x00, 0x08, 0x01, 0x01 };
                rtu_client.Send(data);
            }
        }
        ...
        public void RedLightOn()
        {
            ...
            {
               // current_state |= 0x02;
                List<Byte> data = new List<byte> { 0x01, 0x0F, 0x00, 0x00, 0x00, 0x08, 0x01, 0x02 };
                rtu_client.Send(data);
            }
        }
        ...
        public void CloseAllLight()
        {
            ...
            {
                //current_state |= 0x02;
                List<Byte> data = new List<byte> { 0x01, 0x0F, 0x00, 0x00, 0x00, 0x08, 0x01, 0x00 };
                rtu_client.Send(data);
            }
        }
